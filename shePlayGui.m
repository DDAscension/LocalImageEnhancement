 function sheUI
    ...
    labE = uicontrol('Style', 'text', 'String','Multiplicative value E [0 - 50]', 'Position', [180*2 40 140 20]);
    sldE = uicontrol('Style', 'slider', 'Min',0,'Max',50,'Value',4,'Position', [180*2 20 120 20], 'Callback', @sheCallback); 
    ...
    labk1 = uicontrol('Style', 'text', 'String', 'Lower limit local standard dev. k1 (1 - 10)', 'Position', [180*4 - 60 40 240 20]);
    sldk1 = uicontrol('Style', 'slider', 'Min',0,'Max',10,'Value',0.02, 'Position', [180*4 20 120 20], 'Callback', @sheCallback);     
    
    labk2 = uicontrol('Style', 'text', 'String', 'Standard dev. coeff. k2 (1 - 10)', 'Position', [180*5 40 160 20]);
    sldk2 = uicontrol('Style', 'slider', 'Min',0,'Max',10,'Value',0.4, 'Position', [180*5 20 120 20], 'Callback', @sheCallback);
